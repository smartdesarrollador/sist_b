...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets_admin/css/main.css?v=1652870200386') }}">

  <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets_admin/apple-touch-icon.png') }}"/>
  <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets_admin/favicon-32x32.png') }}"/>
  <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets_admin/favicon-16x16.png') }}"/>
...
<script type="text/javascript" src="{{ asset('assets_admin/js/main.min.js?v=1652870200386') }}"></script>

<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js"></script>
<script type="text/javascript" src="{{ asset('assets_admin/js/chart.sample.min.js') }}"></script>
